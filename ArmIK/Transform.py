...
#The origin of the robotic arm is the center of the gimbal, the distance from the center of the camera screen, in cm
...
#Pass in coordinates and image resolution, for example (100, 100, (640, 320))
...
#Incoming coordinates and image resolution, such as (10, (640, 320))
...
# All turns black except for the roi area
...
# Pass in the rect object returned by the minAreaRect function, the extreme point of the wood, the image resolution, and the side length of the wood block
def getCenter(rect, roi, size, square_length):
    x_min, x_max, y_min, y_max = roi
    #According to the coordinates of the center of the wooden block, select the vertex closest to the center of the image as the benchmark for calculating the exact center
    ...
    # Calculate the center point according to the rotation angle of the wood block
